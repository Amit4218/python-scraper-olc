...
url = requests.get(
    "https://overlandingcamping.com/listing/sankri-sanctuary-haven-your-gateway-to-himalayan-overlanding-and-camping-trek-start-point-for-rupin-pass-har-ki-doon-kedarkantha/",
    headers={
...
description_text = "\n".join(
    [p.get_text(strip=True) for p in description.find_all("p")]
)
